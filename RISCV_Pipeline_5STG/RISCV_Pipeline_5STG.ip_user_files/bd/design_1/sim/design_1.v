...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  design_1_top_0_1 top_0
       (.BRAM_PORTB_addr(axi_bram_ctrl_0_bram_addr_a),
        .BRAM_PORTB_clk(axi_bram_ctrl_0_bram_clk_a),
        .BRAM_PORTB_din(axi_bram_ctrl_0_bram_wrdata_a),
        .BRAM_PORTB_dout(top_0_BRAM_PORTB_dout),
        .BRAM_PORTB_en(axi_bram_ctrl_0_bram_en_a),
        .BRAM_PORTB_rst(axi_bram_ctrl_0_bram_rst_a),
        .BRAM_PORTB_we(axi_bram_ctrl_0_bram_we_a),
