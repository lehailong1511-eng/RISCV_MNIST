...
#
# Script generated by Vivado on Tue Jun 30 01:46:19 +0700 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/New_folder/Nam_3/Ki_2/HWandSW/Project/RISCV_Pipeline_5STG/RISCV_Pipeline_5STG.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
