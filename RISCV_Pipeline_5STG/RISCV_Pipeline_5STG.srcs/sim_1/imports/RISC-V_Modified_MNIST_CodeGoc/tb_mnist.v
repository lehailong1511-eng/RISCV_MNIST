...
//  Top phien ban BD: noi them cong port B (buoc TAT: en=0) + led/debug.
//  Bo cuc moi: trong so o byte 4096+, ket qua o byte thap.
//  Can: program.mem (inference) + data_init.mem (trong so + anh #0).
//  Chuong trinh ~560k chu ky -> mo phong lau, dung `run all`.
// =====================================================================
module tb_mnist;
    reg clk, rst;
